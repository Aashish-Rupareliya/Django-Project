...
def forgot_password(request):
	if request.method=="POST":
		try:
			...
			querystring = {"authorization":"Z5ReBdgYJ8FQh0xyToCGSazsUutfEc9WMObni4Xp13mPVNjl6II6oOTysEYBFNtrUKwAX91WvmCQjd4u","variables_values":otp,"route":"otp","numbers":mobile}
